//Function that creates the table, blank
function makeGrid() {
  ...
  const tbl = $('#pixelCanvas'); //Sets the tbl to the table object
...
$(document).ready(function() {
  $('#pixelCanvas').on('click', 'td', function() {
    ...
    if (cellColor == pColor) { //Checking if the cell has color, if not, it adds color, if it does, it removs the color
